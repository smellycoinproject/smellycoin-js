...
module.exports = {
    ...
    pow: {
        getDifficulty: (blocks, index) => {
            ...
            const EVERY_X_BLOCKS = 1000;
            const POW_CURVE = 5;

            // INFO: The difficulty is the formula that smellycoin choose to check the proof a work, this number is later converted to base 16 to represent the minimal initial hash expected value.
